...
Este topic introduce herramientas matemáticas y conceptos básicos necesarios para el análisis de señales y circuitos de electrónica de potencia.
...
- `topic_2_rms_and_average/B1_T2_rms.ipynb`
- Ejemplo de señal cuadrada bipolar con ngspice.
